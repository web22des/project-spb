(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".sw1", {
        ...
        if (document.querySelector(".swiper")) new core(".sw2", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swiper")) new core(".sw3", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swiper")) new core(".sw4", {
